...
Nguồn gốc: `ConSynth-X/CLAUDE.md`. File này là bản trích cho agents.
...
5. **Phân biệt 3 loại statement**:
   ...
   - Design decision → ghi `docs/methods.md` + lý do
...
- Trước khi đề xuất threshold/param mới → kiểm `docs/methods.md` + `docs/literature.md`.
